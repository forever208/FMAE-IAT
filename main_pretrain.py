...
def main(args):
    ...
    sampler_train = torch.utils.data.DistributedSampler(
        combined_dataset, num_replicas=num_tasks, rank=global_rank, shuffle=True
    )
    ...
    data_loader_train = torch.utils.data.DataLoader(
        combined_dataset, sampler=sampler_train,
    ...
    model.to(device)
    # summary(model, input_size=(3, args.input_size, args.input_size), batch_size=-1)
