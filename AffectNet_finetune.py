...
from util.datasets import build_AffectNet_dataset
...
def get_args_parser():
    parser = argparse.ArgumentParser('MAE fine-tuning for AU classification', add_help=False)
    ...
    # Dataset parameters
    parser.add_argument('--root_path', default=None, type=str, help='dataset root path')
    parser.add_argument('--train_path', default='YOUR_PATH', type=str, help='path of training image folder')
    parser.add_argument('--test_path', default='YOUR_PATH', type=str, help='path of testing image folder')
...
def main(args):
    ...
    dataset_train = build_AffectNet_dataset(args.train_path, is_train=True, args=args)
