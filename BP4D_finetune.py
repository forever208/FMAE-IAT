...
from util.datasets import build_AU_dataset
...
def main(args):
    ...
    dataset_train = build_AU_dataset(args.train_path, is_train=True, args=args)
    dataset_val = build_AU_dataset(args.test_path, is_train=False, args=args)
